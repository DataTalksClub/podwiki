...
[Greg Coquillo]({{ '/people/gregcoquillo/' | relative_url }}) gives the broad
principle in
...
([11:38-15:10]({{ '/podcasts/product-designer-to-data-product-manager/' | relative_url }})).

[Geo Jolly]({{ '/people/geojolly/' | relative_url }}) gives the technical
platform version in
...
[Anna Hannemann]({{ '/people/annahannemann/' | relative_url }}) adds a
...
([8:48-20:00]({{ '/podcasts/last-mile-data-delivery-and-data-product-adoption-modern-data-stack/' | relative_url }})).
...
([41:44-51:11]({{ '/podcasts/building-and-scaling-ai-data-products-with-mlops/' | relative_url }})).
...
([28:37-34:10]({{ '/podcasts/ml-product-manager-and-mlops-platform-strategy/' | relative_url }})).
