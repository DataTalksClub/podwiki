...
[Mikio Braun]({{ '/people/mikiobraun/' | relative_url }}) anchors the proposal
mechanics in
[Freelancing in Machine Learning]({{ '/podcasts/freelancing-in-machine-learning/' | relative_url }}).
[Vin Vashishta]({{ '/people/vinvashishta/' | relative_url }}) adds the business
...
[Marianna Diachuk]({{ '/people/mariannadiachuk/' | relative_url }}) adds the
...
([50:38-55:00]({{ '/podcasts/solopreneur-data-scientist/' | relative_url }})).
...
([21:31]({{ '/podcasts/solopreneur-data-scientist/' | relative_url }})). In the
first month, she tries to produce research, insights, or a draft model
([22:49]({{ '/podcasts/solopreneur-data-scientist/' | relative_url }})).
...
([24:07]({{ '/podcasts/solopreneur-data-scientist/' | relative_url }})).
...
([20:15]({{ '/podcasts/freelancing-in-machine-learning/' | relative_url }})).
Diachuk treats continuous expectation management as part of data science work,
especially because ML isn't deterministic
([26:20-27:35]({{ '/podcasts/solopreneur-data-scientist/' | relative_url }})).
...
[the startup episode]({{ '/podcasts/solopreneur-data-scientist/' | relative_url }}),
...
[his freelancing episode]({{ '/podcasts/freelancing-in-machine-learning/' | relative_url }}).
