...
algorithmic trading near [[Data Science]]
...
[[Evaluation]]. A useful strategy also
...
This is where [[data science]] habits
...
[[Evaluation]] also has to match the
...
belongs with both [[Evaluation]] and
[[Machine Learning]], but it needs
...
separate topic after [[Model Monitoring]]
or deployment
([[podcast:algorithmic-trading-with-python-and-machine-learning|Algorithmic Trading with Python]]).
...
For production-minded teams, [[MLOps]] and
...
([[podcast:algorithmic-trading-with-python-and-machine-learning|Algorithmic Trading with Python]]).
That ties algorithmic trading to the broader [[Data Science]]
