...
[machine learning]({{ '/wiki/machine-learning/' | relative_url }}), or adjacent
data roles.
...
puts it near
[Teaching]({{ '/wiki/teaching/' | relative_url }}) and
...
direction, such as [AI Engineer Role]({{ '/wiki/ai-engineer-role/' | relative_url }})
