...
[Tomasz Hinc]({{ '/people/tomaszhinc/' | relative_url }}) discusses Terraform,
...
[Willem Pienaar]({{ '/people/willempienaar/' | relative_url }}) shows a
...
decoration. [Atita Arora]({{ '/people/atitaarora/' | relative_url }}) starts
...
[Daniel Svonava]({{ '/people/danielsvonava/' | relative_url }}) adds the
