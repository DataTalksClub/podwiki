...
summary: "A bridge page for podcast evidence about internal platform teams and developer experience."
related:
  - ML Platforms
...
- Build-versus-buy is rarely pure. Platform engineers often integrate managed
  tools, open-source components, and custom glue so the pieces fit the
  company's workflows.
- Operational support changes team size because on-call needs and business
  criticality matter, and platform load affects staffing more than a generic
  headcount rule.
...
- [Building Production ML Platforms](https://datatalks.club/podcast.html):
  ...
  for teams that ship ML products. He names cloud, Kubernetes, Terraform, and
  workflow knowledge. He also covers mixed teams and on-call considerations. At
  47:08-51:15, he warns against building a large platform before teams have
  real use cases.
...
- [Data Engineering Platforms](https://datatalks.club/podcast.html): Data
  platform episodes add the same repeated structure on the data side. They
  cover self-service, conventions, contracts, and ownership. See
