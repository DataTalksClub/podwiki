...
At 31:40-43:02 she describes courses and mentoring. She also describes
...
[Data Product Manager guide]({{ '/wiki/data-product-manager/' | relative_url }})
...
The nearby
[Product Analyst guide]({{ '/wiki/product-analyst/' | relative_url }})
...
[Data Roles]({{ '/wiki/data-roles/' | relative_url }}) for the role-specific
portfolio structure.
