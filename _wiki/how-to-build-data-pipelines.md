...
[Santona Tuli](https://datatalks.club/people/santonatuli.html) describes pipeline
...
([Modern Data Pipeline Architecture on raw-to-answer layers at 37:10-46:01](https://datatalks.club/podcast/modern-data-pipelines-orchestration-ingestion-modeling.html)).

In the modern stack episode,
[Natalie Kwong](https://datatalks.club/people/nataliekwong.html) makes the same
...
([ELT raw-to-marts split at 17:55-19:26](https://datatalks.club/podcast/data-engineering-tools-modern-data-stack.html)).
...
([pipeline keys and entities at 39:23-43:05](https://datatalks.club/podcast/modern-data-pipelines-orchestration-ingestion-modeling.html)).

For product and growth data, that consumer-first work begins even earlier.
[Arpit Choudhury](https://datatalks.club/people/arpitchoudhury.html) recommends a
...
([tracking plan ownership at 13:34-23:27](https://datatalks.club/podcast/data-led-growth-event-tracking-and-reverse-etl.html)).
...
([ELT ingestion-to-marts split at 17:55-19:26](https://datatalks.club/podcast/data-engineering-tools-modern-data-stack.html)).
...
([ingestion guardrails at 37:10-39:22](https://datatalks.club/podcast/modern-data-pipelines-orchestration-ingestion-modeling.html)).
...
([warehouses and data swamps at 19:50-28:07](https://datatalks.club/podcast/data-engineering-tools-modern-data-stack.html)).
...
([modeled data layers at 39:23-43:05](https://datatalks.club/podcast/modern-data-pipelines-orchestration-ingestion-modeling.html)).
...
([dbt and marts at 7:57-18:47](https://datatalks.club/podcast/data-engineering-tools-modern-data-stack.html)).
...
([ML pipeline outputs at 44:57-46:01](https://datatalks.club/podcast/modern-data-pipelines-orchestration-ingestion-modeling.html)).
...
[Mehdi OUAZZA](https://datatalks.club/people/mehdiouazza.html) says a platform is
...
a bottleneck
([self-service platform conventions at 12:30-17:56](https://datatalks.club/podcast/scaling-data-engineering-teams-self-service-platforms.html)).
...
([Kafka schema-change rules at 23:26-26:52](https://datatalks.club/podcast/scaling-data-engineering-teams-self-service-platforms.html)).
...
warning in [Barr Moses](https://datatalks.club/people/barrmoses.html)'s data
...
([observability signals at 16:38-19:10](https://datatalks.club/podcast/data-quality-data-observability-data-reliability.html)).
...
([freshness SLAs at 35:24-40:43](https://datatalks.club/podcast/data-quality-data-observability-data-reliability.html)).
Link those expectations to
[Data Quality and Observability]({{ '/wiki/data-quality-and-observability/' | relative_url }})
and [Data Observability]({{ '/wiki/data-quality-and-observability/' | relative_url }}).

[Christopher Bergh](https://datatalks.club/people/christopherbergh.html) turns the
...
([DataOps tests at 15:52-16:10 and 30:55-43:02](https://datatalks.club/podcast/dataops-for-data-engineering.html)).
...
governance
([runbooks and versioning at 33:47-51:21](https://datatalks.club/podcast/dataops-automation-and-reliable-data-pipelines.html)).
...
([collection-to-activation flow at 22:50-30:03 and 56:08-1:00:29](https://datatalks.club/podcast/data-led-growth-event-tracking-and-reverse-etl.html)).
...
([reverse ETL into Salesforce at 35:42-38:36](https://datatalks.club/podcast/data-engineering-tools-modern-data-stack.html)).
Arpit names the same operational-analytics path and connects it to tools such
as Census, Hightouch, and Grouparoo
([reverse ETL tools at 37:25-44:24](https://datatalks.club/podcast/data-led-growth-event-tracking-and-reverse-etl.html)).
