...
MLOps version in
[Pragmatic MLOps at 11:10 and 12:42]({{ '/podcasts/pragmatic-and-standardized-mlops/' | relative_url }}).
...
([Mastering DataOps at 33:47 / 34:37 / 56:32]({{ '/podcasts/dataops-automation-and-reliable-data-pipelines/' | relative_url }})).

Vechtomova starts with the infrastructure a company already has. In
[Pragmatic MLOps at 16:27 and 18:41]({{ '/podcasts/pragmatic-and-standardized-mlops/' | relative_url }}),
...
[Raphaël Hoogvliets]({{ '/people/raphaelhoogvliets/' | relative_url }}) puts
...
([MLOps at Scale at 27:56 / 32:46 / 36:55]({{ '/podcasts/mlops-at-scale-reproducibility-adoption/' | relative_url }})).
[Nadia Nahar]({{ '/people/nadianahar/' | relative_url }}) puts shared
...
defects
([Software Engineering for ML at 13:52 and 39:05]({{ '/podcasts/software-engineering-for-machine-learning/' | relative_url }})).
...
([Mastering DataOps at 33:47 and 51:21]({{ '/podcasts/dataops-automation-and-reliable-data-pipelines/' | relative_url }})).
...
([Pragmatic MLOps at 20:49 / 29:55 / 33:24]({{ '/podcasts/pragmatic-and-standardized-mlops/' | relative_url }})).
...
([MLOps at Scale at 42:31 / 53:08 / 56:50]({{ '/podcasts/mlops-at-scale-reproducibility-adoption/' | relative_url }})).
...
[Production AI Engineering at 9:05 / 11:47 / 13:14]({{ '/podcasts/production-ready-ai-engineering/' | relative_url }}),
[Bartosz Mikulski]({{ '/people/bartoszmikulski/' | relative_url }}) compares
...
quality discussion
([Production AI Engineering at 28:16 / 30:00 / 31:45]({{ '/podcasts/production-ready-ai-engineering/' | relative_url }})).

Product experiments need different gates. In
[Product Analytics and A/B Testing at 8:13 and 24:44]({{ '/podcasts/ab-testing-and-product-experimentation/' | relative_url }}),
...
([Product Analytics and A/B Testing at 27:52 / 33:23 / 37:44 / 40:23 / 44:39]({{ '/podcasts/ab-testing-and-product-experimentation/' | relative_url }})).
...
[Contribute to Open Source ML at 25:50 and 27:40]({{ '/podcasts/open-source-ml-contributions/' | relative_url }}),
...
([Mastering DataOps at 6:42 / 33:47 / 43:06 / 44:12]({{ '/podcasts/dataops-automation-and-reliable-data-pipelines/' | relative_url }})).

Vechtomova describes reusable CI/CD templates and standardized repositories as
central MLOps team responsibilities
([Pragmatic MLOps at 12:42 and 29:55]({{ '/podcasts/pragmatic-and-standardized-mlops/' | relative_url }})).
...
release path works
([MLOps at Scale at 39:06 / 48:41 / 53:08]({{ '/podcasts/mlops-at-scale-reproducibility-adoption/' | relative_url }})).
...
([Contribute to Open Source ML at 22:20 / 24:10 / 27:40]({{ '/podcasts/open-source-ml-contributions/' | relative_url }})).
...
([Software Engineering for ML at 13:52 / 39:05 / 42:47 / 54:16]({{ '/podcasts/software-engineering-for-machine-learning/' | relative_url }})).
...
([Mastering DataOps at 34:37 and 38:01]({{ '/podcasts/dataops-automation-and-reliable-data-pipelines/' | relative_url }})).
...
([Contribute to Open Source ML at 22:20 and 24:10]({{ '/podcasts/open-source-ml-contributions/' | relative_url }})).
...
([Mastering DataOps at 7:22 and 24:59]({{ '/podcasts/dataops-automation-and-reliable-data-pipelines/' | relative_url }})).
...
([Pragmatic MLOps at 34:29 / 35:21 / 42:53 / 51:24]({{ '/podcasts/pragmatic-and-standardized-mlops/' | relative_url }})).
...
[Product Analytics and A/B Testing at 14:27 / 24:44 / 37:44 / 47:44]({{ '/podcasts/ab-testing-and-product-experimentation/' | relative_url }}).
