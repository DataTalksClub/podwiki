...
- [[Job Search]] for targeting,
  outreach, interviews, offers, and rejection handling.
- [[Data Scientist Interview Roadmap]]
  for the full data scientist interview path.
- [[Machine Learning Portfolio Projects]]
  for project selection, baselines, evaluation, and production-aware ML proof.
- [[Portfolio Projects]] for
  broader project evidence across data roles.
