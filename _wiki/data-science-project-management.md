...
and organizational work. In [CRISP-DM](https://datatalks.club/podcast/crisp-dm.html),
...
[Why Data Science Projects Fail](https://datatalks.club/books/20241118-why-data-science-projects-fail-harsh-realities-of-implementing-ai-and-analytics-without-hype-chapman-hall-crc-data-science-series.html)
...
In [From Project Manager to Data Scientist](https://datatalks.club/podcast/project-manager-to-data-scientist.html),
[Ksenia Legostay](https://datatalks.club/people/ksenialegostay.html) treats planning
...
In [CRISP-DM](https://datatalks.club/podcast/crisp-dm.html), the 13:25 section
...
at Scale](https://datatalks.club/podcast/building-data-products-lead-data-scientist.html),
[Ioannis Mesionis](https://datatalks.club/people/ioannismesionis.html) describes an
...
([7:23-27:25](https://datatalks.club/podcast/building-data-products-lead-data-scientist.html)).
...
[Shir Meir Lador](https://datatalks.club/people/shirmeirlador.html) focuses on
uncertainty management in [Data Science Management and Agile Machine Learning](https://datatalks.club/podcast/data-science-management-and-agile-machine-learning.html).
...
([9:18-17:23 and 41:06-54:59](https://datatalks.club/podcast/data-science-management-and-agile-machine-learning.html)).
...
[Yury Kashnitsky](https://datatalks.club/people/yurykashnitsky.html) makes the
...
In [CRISP-DM](https://datatalks.club/podcast/crisp-dm.html), the 7:55, 10:58, and
...
Babushkin](https://datatalks.club/people/valeriybabushkin.html) makes that explicit
for [ML System Design Documents]({{ '/wiki/ml-system-design-documents/' | relative_url }})
in [ML System Design Playbook](https://datatalks.club/podcast/ml-system-design.html).
...
engineering, a model, or a productized ML system. [Anna Hannemann](https://datatalks.club/people/annahannemann.html)
gives that product-owner judgment in [Product Owners in Data Science](https://datatalks.club/podcast/building-data-products-product-owner-vs-product-manager.html).
...
decision path. [Loris Marini](https://datatalks.club/people/lorismarini.html)
starts [Business Skills for Data Professionals in SaaS](https://datatalks.club/podcast/data-professionals-business-skills-in-saas.html)
...
([7:23-15:23](https://datatalks.club/podcast/building-data-products-lead-data-scientist.html)).
...
([35:38-41:33](https://datatalks.club/podcast/building-data-products-lead-data-scientist.html)).
...
Sobkowiak](https://datatalks.club/people/barbarasobkowiak.html) separates data
science managers from experts in [Data Science Manager vs Expert](https://datatalks.club/podcast/data-science-manager-vs-expert-hiring-guide.html).
...
Baselines make progress visible before the final model exists. In [CRISP-DM](https://datatalks.club/podcast/crisp-dm.html),
the 17:05 section treats a sufficient baseline as a reason to move to
evaluation. In [Machine Learning System Design Interviews](https://datatalks.club/podcast/machine-learning-system-design-interview.html),
...
Metrics need a decision owner and a unit of action. [Adam Sroka](https://datatalks.club/people/adamsroka.html)
frames KPI design as top-down alignment with executive decisions in [KPI Design
& Metrics Strategy](https://datatalks.club/podcast/ml-engineering-kpis-and-metrics-strategy.html)
...
([17:37-25:17](https://datatalks.club/podcast/building-data-products-lead-data-scientist.html)).
...
([20:54-40:49](https://datatalks.club/podcast/building-data-products-lead-data-scientist.html)).
...
change, ship, or stop. In [From Analytics to Production ML](https://datatalks.club/podcast/production-ml-mlops-and-data-team-building.html),
...
Adoption is also part of completion. [Caitlin Moorman](https://datatalks.club/people/caitlinmoorman.html)
argues in [Last-Mile Data Delivery](https://datatalks.club/podcast/last-mile-data-delivery-and-data-product-adoption-modern-data-stack.html)
...
model
([4:50-29:23 and 46:28-50:30](https://datatalks.club/podcast/human-centered-mlops-and-model-monitoring.html)).
