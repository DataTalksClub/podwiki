...
Use this page as the comparison layer between adjacent operating models:
...
That's why [MLOps Tools]({{ '/articles/mlops-tools/' | relative_url }})
and [MLOps Architecture]({{ '/articles/mlops-architecture/' | relative_url }})
