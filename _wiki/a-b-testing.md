...
A/B testing is a randomized experiment where one group receives a control
experience and another receives a changed experience, then both groups are
compared on preselected metrics. In the DataTalks.Club archive, A/B testing is
the clearest way to establish whether a product or model change caused an
outcome under live conditions.

This page focuses on online product and ML experiments. Use
...
trials: split a stable unit such as a user, session, account, or device; expose
one group to a change; keep another as control; and compare outcomes over time.
...
it harder to learn whether the testing process itself works.
...
- [Product Analytics and A/B Testing](https://datatalks.club/podcast.html),
  ...
  assignment tracking, A/A tests, and simple first-test design.
- [Product Analytics and A/B Testing](https://datatalks.club/podcast.html),
...
- [From Analytics to Production ML](https://datatalks.club/podcast.html),
  31:19-32:47: connects A/B tests to live model evaluation, uplift analysis, and
  analyst knowledge of business metrics.
