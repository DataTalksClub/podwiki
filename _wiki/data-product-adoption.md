...
([last-mile data delivery, 8:48-15:56](https://datatalks.club/podcast/last-mile-data-delivery-and-data-product-adoption-modern-data-stack.html)).
...
changes what people do. In [Moorman's](https://datatalks.club/people/caitlinmoorman.html)
...
definitions and proactive data-quality communication. [Lior Barak](https://datatalks.club/people/liorbarak.html)
also argues that users need enough visibility into how numbers are produced
before they'll use them confidently
([data translator role, 4:08-13:15](https://datatalks.club/podcast/data-translator-role-and-data-strategy.html)).

## Adoption Levers Across Roles

Guests agree that adoption is behavioral, but they assign the work to different
operating levers. [Moorman](https://datatalks.club/people/caitlinmoorman.html)
...
meeting rituals
([last-mile data delivery, 34:00-40:53](https://datatalks.club/podcast/last-mile-data-delivery-and-data-product-adoption-modern-data-stack.html)).

[Barak's](https://datatalks.club/people/liorbarak.html) organizational translation
...
([data translator role, 14:20-29:19](https://datatalks.club/podcast/data-translator-role-and-data-strategy.html)).

[Tammy Liang](https://datatalks.club/people/tammyliang.html) approaches adoption as
...
([building and scaling a data team, 17:11-22:34 and 47:08-50:52](https://datatalks.club/podcast/building-and-scaling-data-team.html)).

[Lina Weichbrodt](https://datatalks.club/people/linaweichbrodt.html) applies the
...
([human-centered MLOps, 4:50-12:22](https://datatalks.club/podcast/human-centered-mlops-and-model-monitoring.html)).

[Adam Sroka](https://datatalks.club/people/adamsroka.html) puts heavier weight on
...
([KPI design and metrics strategy, 22:41-44:59](https://datatalks.club/podcast/ml-engineering-kpis-and-metrics-strategy.html)).

## Trust Before Usage

Several guests argue that adoption breaks when trust breaks. [Barak](https://datatalks.club/people/liorbarak.html)
...
([data translator role, 7:46-13:15](https://datatalks.club/podcast/data-translator-role-and-data-strategy.html)).

[Liang](https://datatalks.club/people/tammyliang.html) gives the operational
...
([building and scaling a data team, 35:38-41:42](https://datatalks.club/podcast/building-and-scaling-data-team.html)).

For ML systems, [Weichbrodt](https://datatalks.club/people/linaweichbrodt.html)
...
([human-centered MLOps, 18:29-27:14](https://datatalks.club/podcast/human-centered-mlops-and-model-monitoring.html)).

## Decision-First Design

[Moorman's](https://datatalks.club/people/caitlinmoorman.html) strongest adoption
...
([last-mile data delivery, 34:00-38:15](https://datatalks.club/podcast/last-mile-data-delivery-and-data-product-adoption-modern-data-stack.html)).

Decision-first adoption work links data product adoption to [metrics]({{ '/wiki/metrics/' | relative_url }}).
[Sroka](https://datatalks.club/people/adamsroka.html) argues that KPIs should be
...
Guests repeatedly treat low adoption as a user-research signal. [Moorman](https://datatalks.club/people/caitlinmoorman.html)
...
[Barak](https://datatalks.club/people/liorbarak.html) makes a similar case for
...
implementation
([data translator role, 14:20-34:52](https://datatalks.club/podcast/data-translator-role-and-data-strategy.html)).

## Enablement and Operating Rituals

Adoption is also reinforced through rituals. [Liang's](https://datatalks.club/people/tammyliang.html)
...
[Weichbrodt](https://datatalks.club/people/linaweichbrodt.html) describes
...
([human-centered MLOps, 4:50-15:07 and 54:49-56:28](https://datatalks.club/podcast/human-centered-mlops-and-model-monitoring.html)).

## Measuring Behavior Change

Adoption evidence shouldn't stop at page views or dashboard counts. [Moorman](https://datatalks.club/people/caitlinmoorman.html)
...
[Sroka](https://datatalks.club/people/adamsroka.html) gives data teams a more
...
([KPI design and metrics strategy, 51:12-1:00:02](https://datatalks.club/podcast/ml-engineering-kpis-and-metrics-strategy.html)).
