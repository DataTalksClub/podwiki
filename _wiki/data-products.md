...
[Sara Menefee]({{ '/people/saramenefee/' | relative_url }}) adds the product
manager view in
...
[Anna Hannemann]({{ '/people/annahannemann/' | relative_url }}) starts from
product ownership in data science. In
[Building Data Products at Scale]({{ '/podcasts/building-data-products-product-owner-vs-product-manager/' | relative_url }}),
...
[Ioannis Mesionis]({{ '/people/ioannismesionis/' | relative_url }}) frames data
...
[Arpit Choudhury]({{ '/people/arpitchoudhury/' | relative_url }}) walks through
