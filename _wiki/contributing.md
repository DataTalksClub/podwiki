...
instructions, office hours, scoped tasks, and maintainer feedback.

## Contribution Paths

These contribution paths recur across the archive.

- Reproducible issue: include versions, environment, input, expected behavior,
  actual behavior, and a minimal reproduction.
- Documentation fix: improve a README, quickstart, guide, API reference, error
  message, or example.
- Small code PR: fix one bug or add one narrow improvement with tests.
- Project example: publish a notebook, demo, tutorial, or video that makes the
  first useful action easier.
- Community contribution: answer questions, mentor learners, review projects,
  help in Slack, or join Project of the Week.
- Maintainer support: triage issues, improve templates, clarify contribution
  guides, or reduce CI and packaging friction.
