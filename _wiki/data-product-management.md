...
([4:58-16:26 and 7:04-15:10]({{ '/podcasts/product-designer-to-data-product-manager/' | relative_url }})).
...
[Caitlin Moorman]({{ '/people/caitlinmoorman/' | relative_url }}) extends
...
[Anna Hannemann]({{ '/people/annahannemann/' | relative_url }}) ties problem
...
[Geo Jolly]({{ '/people/geojolly/' | relative_url }}) shows it through
...
[Ioannis Mesionis]({{ '/people/ioannismesionis/' | relative_url }}) shows the
