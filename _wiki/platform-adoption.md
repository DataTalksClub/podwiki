...
change their work
([Building Production ML Platforms, 10:47-20:04](https://datatalks.club/podcast/building-production-ml-platform-and-mlops-team.html),
[Last-Mile Data Delivery, 20:02-26:21](https://datatalks.club/podcast/last-mile-data-delivery-and-data-product-adoption-modern-data-stack.html)).

## Adoption in Practice

Across the platform episodes, a team has adopted a platform when it changes its
normal way of working. [Raphaël Hoogvliets](https://datatalks.club/people/raphaelhoogvliets.html)
...
[Geo Jolly](https://datatalks.club/people/geojolly.html) uses the product-management
...
([ML Product Manager and MLOps Platform Strategy, 11:24-16:44 and 55:44](https://datatalks.club/podcast/ml-product-manager-and-mlops-platform-strategy.html)).

Tool coverage isn't the same as adoption. [Simon Stiebellehner](https://datatalks.club/people/simonstiebellehner.html)
...
([MLOps at Scale, 32:46-36:55](https://datatalks.club/podcast/mlops-at-scale-reproducibility-adoption.html)).
...
([MLOps at Scale, 39:06-53:08](https://datatalks.club/podcast/mlops-at-scale-reproducibility-adoption.html)).

[Caitlin Moorman](https://datatalks.club/people/caitlinmoorman.html) makes the same
...
([Building Production ML Platforms, 28:20-31:51](https://datatalks.club/podcast/building-production-ml-platform-and-mlops-team.html)).
...
([Building Production ML Platforms, 34:01-38:40](https://datatalks.club/podcast/building-production-ml-platform-and-mlops-team.html)).

[Mehdi OUAZZA](https://datatalks.club/people/mehdiouazza.html) gives the data
...
([Scaling Data Engineering Teams and Self-Service Platforms, 12:30-17:22](https://datatalks.club/podcast/scaling-data-engineering-teams-self-service-platforms.html)).
...
([Scaling Data Engineering Teams and Self-Service Platforms, 23:26](https://datatalks.club/podcast/scaling-data-engineering-teams-self-service-platforms.html)).
...
([Scaling Data Engineering Teams and Self-Service Platforms, 17:22](https://datatalks.club/podcast/scaling-data-engineering-teams-self-service-platforms.html)).
...
([DataOps 101, 7:52-11:50](https://datatalks.club/podcast/dataops-principles-and-scalable-data-platforms.html)).
...
([Building Production ML Platforms, 8:11-20:04 and 47:08-49:19](https://datatalks.club/podcast/building-production-ml-platform-and-mlops-team.html)).
...
([Scaling Data Engineering Teams and Self-Service Platforms, 20:13](https://datatalks.club/podcast/scaling-data-engineering-teams-self-service-platforms.html)).
...
capability and when
([ML Product Manager and MLOps Platform Strategy, 9:50-16:44 and 45:18-48:10](https://datatalks.club/podcast/ml-product-manager-and-mlops-platform-strategy.html)).

[Lina Weichbrodt](https://datatalks.club/people/linaweichbrodt.html) adds the human
...
([Human-Centered MLOps and Model Monitoring, 4:50-24:34](https://datatalks.club/podcast/human-centered-mlops-and-model-monitoring.html)).
...
([Human-Centered MLOps and Model Monitoring, 24:34-27:14](https://datatalks.club/podcast/human-centered-mlops-and-model-monitoring.html)).
...
([Building Production ML Platforms, 20:04 and 49:19](https://datatalks.club/podcast/building-production-ml-platform-and-mlops-team.html)).
...
([ML Product Manager and MLOps Platform Strategy, 48:10-54:58](https://datatalks.club/podcast/ml-product-manager-and-mlops-platform-strategy.html)).
...
([DataOps 101, 7:52 and 50:13](https://datatalks.club/podcast/dataops-principles-and-scalable-data-platforms.html)).
...
([MLOps at Scale, 36:55](https://datatalks.club/podcast/mlops-at-scale-reproducibility-adoption.html)).
...
([ML Product Manager and MLOps Platform Strategy, 29:23 and 55:44](https://datatalks.club/podcast/ml-product-manager-and-mlops-platform-strategy.html)).
...
decision
([Last-Mile Data Delivery, 41:18-49:25](https://datatalks.club/podcast/last-mile-data-delivery-and-data-product-adoption-modern-data-stack.html)).
...
([Building Production ML Platforms, 47:08-49:19](https://datatalks.club/podcast/building-production-ml-platform-and-mlops-team.html)).
...
([Scaling Data Engineering Teams and Self-Service Platforms, 17:22-23:26](https://datatalks.club/podcast/scaling-data-engineering-teams-self-service-platforms.html)).
...
([Human-Centered MLOps and Model Monitoring, 12:22-24:34](https://datatalks.club/podcast/human-centered-mlops-and-model-monitoring.html)).
...
better decisions
([Last-Mile Data Delivery, 42:18-45:35](https://datatalks.club/podcast/last-mile-data-delivery-and-data-product-adoption-modern-data-stack.html)).
