...
Teams still need feature necessity reviews, compliance input, and domain
experts. They also need monitoring and human oversight.
...
- [Interpretable Machine Learning](https://datatalks.club/podcast.html)
  (9:27-11:59) explains how SHAP can surface target leakage and
  support debugging even when the headline metric improves.
- [Interpretable Machine Learning](https://datatalks.club/podcast.html)
  (20:27-30:00) covers conformal prediction and calibrated
...
- [Responsible and Explainable AI](https://datatalks.club/podcast.html)
  (8:20-24:22) distinguishes explainability from responsible AI. Supreet covers
  glass-box approaches, What-If Tool, Skater, and AI Explainability 360. She
  also covers LIME, SHAP, feature necessity, and PII handling.
- [Responsible and Explainable AI](https://datatalks.club/podcast.html)
  (32:29-42:39) discusses accuracy versus interpretability, human
