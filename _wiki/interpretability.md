...
effects, calibrate uncertainty, assess fairness, and decide when a simpler model
is better than a more accurate black box.
...
Explainability and responsible AI overlap but are not the same. Supreet Kaur
...
- [Interpretable Machine Learning](https://datatalks.club/podcast.html),
  20:27-29:60: the episode covers conformal prediction, calibrated uncertainty,
  SHAP, and the terminology difference between explainable AI and interpretable
  machine learning.
- [Responsible and Explainable AI](https://datatalks.club/podcast.html),
  8:20-24:22: Supreet Kaur distinguishes explainability from responsible AI and
  covers glass-box approaches, What-If Tool, Skater, AI Explainability 360, LIME,
  SHAP, feature necessity, and PII handling.
- [Responsible and Explainable AI](https://datatalks.club/podcast.html),
...
- [Fairness in AI and ML Engineering](https://datatalks.club/podcast.html),
  21:31-46:20: covers Fairlearn tools, group fairness, metric tradeoffs,
  human judgment, and inspection tools such as partial dependence.
- [Practical Machine Learning Engineering for Production](https://datatalks.club/podcast.html):
  supports the same pattern from an engineering angle: prefer maintainable,
...
When adding evidence, name the audience for the explanation: model developer,
business owner, domain expert, auditor, or affected user. Keep tool lists short
unless the transcript explains how the tool changes a modeling or governance
decision.
