...
[Christoph Molnar](https://datatalks.club/people/christophmolnar.html)'s
...
[Supreet Kaur](https://datatalks.club/people/supreetkaur.html)'s
[Responsible and Explainable AI](https://datatalks.club/podcast/responsible-explainable-ai-bias-detection.html)
episode and [Polina Mosolova](https://datatalks.club/people/polinamosolova.html)'s
[Build Explainable and Actionable AI/ML Systems](https://datatalks.club/podcast/building-explainable-and-actionable-ai-ml-systems.html)
...
For a practical Python reference, [Interpretable Machine Learning with Python](https://datatalks.club/books/20210719-interpretable-machine-learning-with-python.html) by Serg Masis covers SHAP, LIME, counterfactual explanations, and the debugging workflows guests describe below.
...
[Tamara Atanasoska](https://datatalks.club/people/tamaraatanasoska.html) ties
...
directly. In
[Responsible and Explainable AI](https://datatalks.club/podcast/responsible-explainable-ai-bias-detection.html),
[Supreet Kaur](https://datatalks.club/people/supreetkaur.html) names tools such as
...
[Interpretable Machine Learning](https://datatalks.club/podcast/interpretable-machine-learning.html),
[Christoph Molnar](https://datatalks.club/people/christophmolnar.html) uses SHAP
...
use. In
[Responsible and Explainable AI](https://datatalks.club/podcast/responsible-explainable-ai-bias-detection.html),
[Supreet Kaur](https://datatalks.club/people/supreetkaur.html) starts with
...
[Supreet Kaur](https://datatalks.club/people/supreetkaur.html) makes this point in
[Responsible and Explainable AI](https://datatalks.club/podcast/responsible-explainable-ai-bias-detection.html)
...
[Polina Mosolova](https://datatalks.club/people/polinamosolova.html) adds the
...
[Thom Ives](https://datatalks.club/people/thomives.html) connects explainability
to production data science in
[Practical Data Science & ML](https://datatalks.club/podcast/feature-engineering-model-monitoring-and-data-governance.html).
...
[Danny Leybzon](https://datatalks.club/people/dannyleybzon.html) gives the MLOps
version in
