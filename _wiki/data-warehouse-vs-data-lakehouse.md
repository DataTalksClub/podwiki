...
A data lakehouse keeps a [[data lake]]
storage boundary while adding warehouse-like table behavior. Metadata, access,
and governance are part of that design. [[person:larsalbertsson|Lars Albertsson]]
...
That boundary favors the [[data warehouse]]
...
to reduce dependence on one vendor runtime. [[person:larsalbertsson|Lars Albertsson]]
...
([[podcast:trends-in-modern-data-engineering|Modern Data Engineering Trends]],
18:17-30:31). He later compares [[Delta Lake]],
Hudi, and Iceberg.
...
Brudaru explains [[Apache Iceberg]]
...
[[DataOps]] framing keeps governance close
...
Both paths need [[data quality and observability]],
