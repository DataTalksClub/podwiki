...
[Danny Ma](https://datatalks.club/people/dannyma.html) gives the career framing
...
([Danny Ma's Builder-path discussion at 25:53-36:46](https://datatalks.club/podcast/data-science-career-abc-framework.html)).
...
complex models
([Ben Wilson's maintainable-code and simplicity discussion at 8:49-13:19 and 44:23-52:14](https://datatalks.club/podcast/machine-learning-engineering-production-best-practices.html)).
...
batch scoring
([machine-learning-engineer role boundary at 17:04-20:54 and serving discussion at 38:52-43:24](https://datatalks.club/podcast/data-team-roles.html)).
...
([Mihail Eric's full-lifecycle ML engineering discussion at 17:35-44:36](https://datatalks.club/podcast/research-to-production-ml-systems-roadmap.html)).

[Ellen Koenig](https://datatalks.club/people/ellenkonig.html) gives a useful
...
([Ellen Koenig's data-science-to-engineering transition discussion at 9:41-28:54](https://datatalks.club/podcast/from-software-engineering-data-science-to-data-engineering-leadership.html)).
...
([Ben Wilson's idea-to-production and agile-for-ML discussion at 29:06-57:38](https://datatalks.club/podcast/machine-learning-engineering-production-best-practices.html)).
...
([Ben Wilson's maintainability and explainability discussion at 21:39-29:06](https://datatalks.club/podcast/machine-learning-engineering-production-best-practices.html)).
...
([Roksolana Diachuk's data-scientist and ML-engineering boundary discussion at 13:56-24:49](https://datatalks.club/podcast/big-data-engineer-vs-data-scientist.html)).
...
([Simon Stiebellehner's ML platform skills and workflow discussion at 8:11-45:50](https://datatalks.club/podcast/building-production-ml-platform-and-mlops-team.html)).
...
([Mihail Eric's embedded-team and full-stack-data-scientist discussion at 34:20-46:57](https://datatalks.club/podcast/research-to-production-ml-systems-roadmap.html)).
...
([Ben Wilson's refactoring discussion at 8:49-10:35](https://datatalks.club/podcast/machine-learning-engineering-production-best-practices.html)).
...
([Danny Ma's A-to-B transition advice at 30:26-36:46](https://datatalks.club/podcast/data-science-career-abc-framework.html)).

The second gap is deployment and operations. [Santiago Valdarrama](https://datatalks.club/people/svpino.html)
...
([Santiago Valdarrama's ML engineering skills discussion at 46:39-51:21](https://datatalks.club/podcast/from-software-engineer-to-machine-learning.html)).
...
([Roksolana Diachuk's recommendation-system serving discussion at 18:54-23:40](https://datatalks.club/podcast/big-data-engineer-vs-data-scientist.html)).

The fourth gap is written system design. [Arseny Kravchenko](https://datatalks.club/people/arsenykravchenko.html)
...
([Arseny Kravchenko's ML system design document discussion at 7:54-37:15](https://datatalks.club/podcast/building-scalable-and-reliable-machine-learning-systems.html)).
...
([Ben Wilson's prototype-to-MVP discussion at 29:06-32:03 and 44:23-52:14](https://datatalks.club/podcast/machine-learning-engineering-production-best-practices.html)).
...
([Simon Stiebellehner's tracking registry serving and lineage discussion at 29:41-45:50](https://datatalks.club/podcast/building-production-ml-platform-and-mlops-team.html)).
...
([Arseny Kravchenko's goals-to-data-strategy discussion at 29:01-37:15](https://datatalks.club/podcast/building-scalable-and-reliable-machine-learning-systems.html)).

Interview evidence should explain the same project without hiding behind tool
names. [Oleg Novikov](https://datatalks.club/people/olegnovikov.html) advises
...
([Oleg's project CV and case-study discussion at 17:13-36:38](https://datatalks.club/podcast/data-science-interview-and-cv-guide.html)).
