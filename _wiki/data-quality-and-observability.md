...
Future agents should add episode evidence when a transcript includes concrete
quality dimensions, failure modes, alerting practices, or recovery workflows.
Avoid adding generic "data quality matters" references unless the episode
contributes a reusable pattern.
