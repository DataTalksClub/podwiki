...
summary: "Podcast-backed guidance on technical writing as a data career skill: audience, cadence, outlines, editing, distribution, workplace docs, and DevRel content."
related:
  - Documentation
  - Developer Relations
  - Career Growth
...
These writing practices recur across the archive.

- Start from a reader and a job. Name what the reader should understand or do
  after reading.
- Outline before drafting when the topic has multiple claims or examples.
...
- [Developer Advocacy Through Community Impact](https://datatalks.club/podcast.html):
  ...
  collaboration.
- [Open Source ML Tools](https://datatalks.club/podcast.html): at 27:24,
  Vincent discusses video scale and communication practice. At 42:20, he
  discusses interactive content and videos for scikit-learn.
- [Career Growth]({{ '/wiki/career-growth/' | relative_url }}): this synthesis
  treats writing, talks, tutorials, and DevRel as public records of judgment.
