...
[Sonal Goyal](https://datatalks.club/people/sonalgoyal.html) gives the clearest
definition in
[Building an Open-Source Identity Resolution Tool](https://datatalks.club/podcast/building-open-source-data-product-for-identity-resolution.html).
At [5:47](https://datatalks.club/podcast/building-open-source-data-product-for-identity-resolution.html),
she defines identity resolution as deciding whether several warehouse records
refer to the same real-world customer. At
[7:20](https://datatalks.club/podcast/building-open-source-data-product-for-identity-resolution.html),
...
[Sonal Goyal](https://datatalks.club/people/sonalgoyal.html) uses a direct
...
[Sonal](https://datatalks.club/people/sonalgoyal.html) separates the technical
linking problem from the downstream action. At
[8:02](https://datatalks.club/podcast/building-open-source-data-product-for-identity-resolution.html) in the
...
[13:38](https://datatalks.club/podcast/building-open-source-data-product-for-identity-resolution.html),
...
[Arpit Choudhury](https://datatalks.club/people/arpitchoudhury.html) frames CDPs as
bundled systems for tracking, segmenting, and activating customer data. Sonal
says at
[24:32](https://datatalks.club/podcast/building-open-source-data-product-for-identity-resolution.html)
...
([5:47](https://datatalks.club/podcast/building-open-source-data-product-for-identity-resolution.html)).
...
[7:20](https://datatalks.club/podcast/building-open-source-data-product-for-identity-resolution.html)
and [11:09](https://datatalks.club/podcast/building-open-source-data-product-for-identity-resolution.html),
[Sonal Goyal](https://datatalks.club/people/sonalgoyal.html) first names suppliers
...
[8:02](https://datatalks.club/podcast/building-open-source-data-product-for-identity-resolution.html),
...
to compare. [Sonal Goyal](https://datatalks.club/people/sonalgoyal.html) describes
the scaling problem at
[14:35](https://datatalks.club/podcast/building-open-source-data-product-for-identity-resolution.html):
...
[18:35](https://datatalks.club/podcast/building-open-source-data-product-for-identity-resolution.html),
...
[41:29](https://datatalks.club/podcast/building-open-source-data-product-for-identity-resolution.html),
...
[49:39](https://datatalks.club/podcast/building-open-source-data-product-for-identity-resolution.html),
...
[18:35](https://datatalks.club/podcast/building-open-source-data-product-for-identity-resolution.html)
and [20:46](https://datatalks.club/podcast/building-open-source-data-product-for-identity-resolution.html),
...
release
([23:00](https://datatalks.club/podcast/building-open-source-data-product-for-identity-resolution.html)).
The open-source choice was partly personal, but it was also a distribution
decision.

At [24:32](https://datatalks.club/podcast/building-open-source-data-product-for-identity-resolution.html),
...
[25:25](https://datatalks.club/podcast/building-open-source-data-product-for-identity-resolution.html)
and [31:10](https://datatalks.club/podcast/building-open-source-data-product-for-identity-resolution.html),
she also says open source helped Zingg discover more use cases than direct sales
alone would have found.

Around [27:00-31:10](https://datatalks.club/podcast/building-open-source-data-product-for-identity-resolution.html),
...
[5:47](https://datatalks.club/podcast/building-open-source-data-product-for-identity-resolution.html)
and [8:02](https://datatalks.club/podcast/building-open-source-data-product-for-identity-resolution.html),
...
([39:11](https://datatalks.club/podcast/building-open-source-data-product-for-identity-resolution.html)).

Fraud and compliance are higher-stakes versions of the same problem. At
[46:08](https://datatalks.club/podcast/building-open-source-data-product-for-identity-resolution.html),
...
[Sonal Goyal](https://datatalks.club/people/sonalgoyal.html)'s public-data example
shows the non-enterprise side. At
[52:23](https://datatalks.club/podcast/building-open-source-data-product-for-identity-resolution.html),
