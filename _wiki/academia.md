...
[From Postdoc to Data Science Lead](https://datatalks.club/podcast/postdoc-to-data-science-lead-career-transition.html)
at 1:28-6:10. [Anastasia Karavdina](https://datatalks.club/people/anastasiakaravdina.html)
maps collider collaborations, high-volume event data, and research software
engineering into industry data science in
[From Collider Physics to Data Science](https://datatalks.club/podcast/from-large-hadron-collider-to-data-science-research-software-engineering.html)
at 11:15-24:31.
...
[Master Spatial Big Data Analytics](https://datatalks.club/podcast/big-data-analytics-and-postdoc-research.html)
...
[Johanna Bayer](https://datatalks.club/people/johannabayer.html) focuses on making
...
[Orell Garten](https://datatalks.club/people/orellgarten.html) uses academic
...
This matters for [job search]({{ '/wiki/job-search/' | relative_url }}) because
...
[production]({{ '/wiki/production/' | relative_url }}), reproducibility, and
...
[David Bader](https://datatalks.club/people/davidbader.html) shows the
institution-building side of academic data science. In
[Building Data Science Programs and Democratizing HPC](https://datatalks.club/podcast/building-data-science-programs-and-democratizing-high-performance-computing.html),
