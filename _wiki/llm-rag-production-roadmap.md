...
[Paul Iusztin](https://datatalks.club/people/pauliusztin.html) describes the
...
[From Notebook to Production: End-to-End AI Systems](https://datatalks.club/podcast/s24e03-from-notebook-to-production-building-end-to-end-ai-systems.html).
...
[Meryem Arik](https://datatalks.club/people/meryemarik.html) separates RAG and
fine-tuning in
...
Use [RAG vs Fine-Tuning]({{ '/wiki/rag-vs-fine-tuning/' | relative_url }})
...
[Daniel Svonava](https://datatalks.club/people/danielsvonava.html) shows the
...
[Aditya Gautam](https://datatalks.club/people/adityagautam.html) adds the
...
18:46 in
[Deploying LLMs in Production](https://datatalks.club/podcast/deploying-llms-in-production-fine-tuning-retrieval-open-source-api.html),
[Meryem Arik](https://datatalks.club/people/meryemarik.html) compares open-source
