...
([Building Production ML Platforms, 6:55-54:15]({{ '/podcasts/building-production-ml-platform-and-mlops-team/' | relative_url }})).
...
([Building Production ML Platforms, 4:42-34:01]({{ '/podcasts/building-production-ml-platform-and-mlops-team/' | relative_url }})).
...
([Building Production ML Platforms, 15:34]({{ '/podcasts/building-production-ml-platform-and-mlops-team/' | relative_url }})).
...
([Building Production ML Platforms, 28:20-30:32]({{ '/podcasts/building-production-ml-platform-and-mlops-team/' | relative_url }})).
...
the same lifecycle
([Building Production ML Platforms, 31:15-34:01]({{ '/podcasts/building-production-ml-platform-and-mlops-team/' | relative_url }})).

Some lifecycle services are conditional. [Willem Pienaar]({{ '/people/willempienaar/' | relative_url }})
...
([Feature Stores for MLOps, 21:00-52:00]({{ '/podcasts/mlops-feature-stores-feature-stores-feast-tecton/' | relative_url }})).
...
platform layers
([Pragmatic MLOps, 16:27-33:24]({{ '/podcasts/pragmatic-and-standardized-mlops/' | relative_url }})).
...
prioritization
([Become an ML Product Manager, 11:24-57:20]({{ '/podcasts/ml-product-manager-and-mlops-platform-strategy/' | relative_url }})).
...
([How to Grow Your ML Engineering Career, 13:25-17:48]({{ '/podcasts/how-to-grow-your-ml-engineering-career/' | relative_url }})).
...
([Building Production ML Platforms, 8:11-13:50]({{ '/podcasts/building-production-ml-platform-and-mlops-team/' | relative_url }})).
...
([How to Grow Your ML Engineering Career, 29:00-37:37]({{ '/podcasts/how-to-grow-your-ml-engineering-career/' | relative_url }})).
...
([Building Production ML Platforms, 51:41]({{ '/podcasts/building-production-ml-platform-and-mlops-team/' | relative_url }})).
Krzysztof frames the useful profile as T-shaped
([How to Grow Your ML Engineering Career, 35:23]({{ '/podcasts/how-to-grow-your-ml-engineering-career/' | relative_url }})).
