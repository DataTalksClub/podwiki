...
production boundaries. [[person:ranjithakulkarni|Ranjitha Kulkarni]]
...
[[person:adityagautam|Aditya Gautam]] frames
...
[[tools]]. They also define what each call
...
Ranjitha also treats [[retrieval-augmented-generation|RAG]] as one tool an
...
[[person:hugobowneanderson|Hugo Bowne-Anderson]] adds a
useful caution in
[[podcast:practical-llm-engineering-and-rag|Practical LLM Engineering and RAG]]:
...
[[person:adityagautam|Aditya Gautam]] extends this to
...
[[person:pauliusztin|Paul Iusztin]] puts that decision
