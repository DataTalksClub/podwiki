...
([Scaling Data Engineering Teams and Self-Service Platforms, 12:30](https://datatalks.club/podcast/scaling-data-engineering-teams-self-service-platforms.html)).
...
([DataOps 101 for Scaling Data Platforms, 7:52-30:34](https://datatalks.club/podcast/dataops-principles-and-scalable-data-platforms.html)).
...
ownership begins. [Mehdi OUAZZA](https://datatalks.club/people/mehdiouazza.html)
...
([Scaling Data Engineering Teams and Self-Service Platforms, 12:30-23:26](https://datatalks.club/podcast/scaling-data-engineering-teams-self-service-platforms.html)).

[Zhamak Dehghani](https://datatalks.club/people/zhamakdehghani.html) pushes the
...
([Data Mesh Implementation, 31:05-53:02](https://datatalks.club/podcast/data-mesh-architecture-decentralized-data-products.html)).
...
([DataOps 101 for Scaling Data Platforms, 50:13](https://datatalks.club/podcast/dataops-principles-and-scalable-data-platforms.html)).

[Rahul Jain](https://datatalks.club/people/16rahuljain.html) describes the same
...
([Data Engineering Leadership and Modern Data Platforms, 4:52 and 25:04](https://datatalks.club/podcast/data-engineering-leadership-and-modern-data-platforms.html)).

[Geo Jolly](https://datatalks.club/people/geojolly.html) adds the product
...
([ML Product Manager and MLOps Platform Strategy, 11:24-18:25 and 55:44](https://datatalks.club/podcast/ml-product-manager-and-mlops-platform-strategy.html)).
...
([DataOps 101 for Scaling Data Platforms, 28:22-30:34](https://datatalks.club/podcast/dataops-principles-and-scalable-data-platforms.html)).
...
([DataOps 101 for Scaling Data Platforms, 16:42-20:12 and 1:04:18](https://datatalks.club/podcast/dataops-principles-and-scalable-data-platforms.html)).
...
lake patterns
([Data Engineering Leadership and Modern Data Platforms, 29:01-30:50](https://datatalks.club/podcast/data-engineering-leadership-and-modern-data-platforms.html)).

[Jessi Ashdown](https://datatalks.club/people/jessiashdown.html) and
[Uri Gilad](https://datatalks.club/people/urigilad.html) make the enablement side
...
([Cloud Data Governance, 14:04-18:33 and 42:04-54:37](https://datatalks.club/podcast/cloud-data-governance.html)).
...
([ML Product Manager and MLOps Platform Strategy, 35:18-40:14 and 55:44](https://datatalks.club/podcast/ml-product-manager-and-mlops-platform-strategy.html)).
...
continue
([Scaling Data Engineering Teams and Self-Service Platforms, 10:21 and 31:07](https://datatalks.club/podcast/scaling-data-engineering-teams-self-service-platforms.html)).
...
([Data Engineering Leadership and Modern Data Platforms, 7:27-23:15](https://datatalks.club/podcast/data-engineering-leadership-and-modern-data-platforms.html)).
...
labels
([DataOps 101 at 50:13](https://datatalks.club/podcast/dataops-principles-and-scalable-data-platforms.html)).
