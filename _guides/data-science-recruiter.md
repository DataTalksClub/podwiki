...
[Luke Whipps]({{ '/people/lukewhipps/' | relative_url }}) gives the headhunter
view.
...
Tereza's discussion of long tech lists and vague responsibilities gives
candidates a way to evaluate the employer. Team-context questions matter as much
as the employer's evaluation of the candidate.
...
Companies should define the job before they start sourcing. That definition
doesn't have to be perfect, but it should cover five points.

1. The decision, product, workflow, or customer problem this person will work
   on.
2. The role's center of gravity: analytics, experimentation, machine learning,
   engineering, research, or team leadership.
...
[Katie Bauer]({{ '/people/katiebauer/' | relative_url }}) adds the team-design
view in
...
[Sarah Mestiri]({{ '/people/sarahmestiri/' | relative_url }}) gives the
...
making dates easy to scan. Keep responsibilities clear and remove irrelevant
personal details.
...
3. The role's main focus: analytics, ML engineering, research, or product
   decision support.
