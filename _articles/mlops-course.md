...
For stack selection, use [MLOps Tools]({{ '/articles/mlops-tools/' | relative_url }}).
...
- [What's MLOps?]({{ '/articles/what-is-mlops/' | relative_url }}) for a short
  definition.
- [MLOps Courses]({{ '/articles/mlops-courses/' | relative_url }}) for the
...
- [MLOps Tools]({{ '/articles/mlops-tools/' | relative_url }}) for stack
  categories.
- [MLOps Frameworks]({{ '/articles/mlops-frameworks/' | relative_url }}) for
