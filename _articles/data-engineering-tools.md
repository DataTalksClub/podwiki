...
search_intent: |
  People searching for "data engineering tools" usually want a practical map of
  the modern data stack. They need to understand tool categories, common
  tradeoffs, and which tools matter first for analytics, platform work, data
  quality, and operational use cases.
related_wiki:
  - Data Engineering
