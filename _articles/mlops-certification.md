...
[MLOps Frameworks]({{ '/articles/mlops-frameworks/' | relative_url }}), and
[MLOps Course]({{ '/articles/mlops-course/' | relative_url }}). For the short
definition, use the [MLOps definition article]({{ '/articles/what-is-mlops/' | relative_url }}).
...
coverage in [MLOps Course]({{ '/articles/mlops-course/' | relative_url }}).
...
- [MLOps Courses]({{ '/articles/mlops-courses/' | relative_url }})
- [MLOps Tools]({{ '/articles/mlops-tools/' | relative_url }})
- [MLOps Frameworks]({{ '/articles/mlops-frameworks/' | relative_url }})
- [MLOps Engineer]({{ '/wiki/mlops-engineer/' | relative_url }})
