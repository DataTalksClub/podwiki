...
[Merve Noyan]({{ '/people/mervenoyan/' | relative_url }}) shows this in
...
[Will Russell]({{ '/people/willrussell/' | relative_url }}) makes onboarding
concrete in
[Demo-First DevRel and Open Source Education]({{ '/podcasts/practical-devrel-demofirst-education-and-open-source/' | relative_url }}).
...
[DevRel for Machine Learning and Open Source]({{ '/podcasts/devrel-open-source-machine-learning/' | relative_url }}).
...
[Developer Personal Brand and Learn in Public]({{ '/podcasts/developer-personal-brand-learn-in-public/' | relative_url }}).
...
[Sara El-Ateif]({{ '/people/saraelateif/' | relative_url }}) and
[Isabella Bicalho]({{ '/people/isabellabicalho/' | relative_url }}) show the
career-switcher path. In
[Open Source and Volunteering in AI]({{ '/podcasts/open-source-and-volunteering-in-ai-for-data-ml-career-growth/' | relative_url }}),
Sara connects collaboration, referrals, and beginner roles to practical
experience. In
[Biology to Machine Learning]({{ '/podcasts/from-biology-to-machine-learning-data-science-portfolio-open-source-computer-vision-transformers/' | relative_url }}),
...
[Open Source ML Tools, Strategy, and Business Models]({{ '/podcasts/open-source-ml-tools-strategy-and-business-models/' | relative_url }}),
