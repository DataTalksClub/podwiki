...
- [Practical Algorithms for Engineers: Bloom Filters, Approximate Nearest-Neighbor & Performance]({{ '/podcasts/algorithms-data-structures-for-engineers/' | relative_url }}). Related topics: algorithms, data structures, [software engineering]({{ '/wiki/software-engineering/' | relative_url }}).
