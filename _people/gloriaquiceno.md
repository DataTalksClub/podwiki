...
- [How I Landed a Data Engineering Job: Bootcamp, Docker, Airflow, AWS & Interview Tips]({{ '/podcasts/get-data-analytics-and-data-engineering-job/' | relative_url }}). Related topics: career switch, [data engineering]({{ '/wiki/data-engineering/' | relative_url }}), [career growth]({{ '/wiki/career-growth/' | relative_url }}).
