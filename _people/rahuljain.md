...
source_url: "https://datatalks.club/people/rahuljain.html"
podcast_episodes: ["mentoring-in-tech-how-to-find-and-become-a-mentor"]
twitter: "rahulj51"
...
- [How to Find a Mentor and Become One: Mentoring Strategies for Tech Careers]({{ '/podcasts/mentoring-in-tech-how-to-find-and-become-a-mentor/' | relative_url }}). Discussed: Episode Introduction; Career Journey: From Mining Engineering to Data Engineering & Leadership; Defining Mentoring: Purpose, Scope, and Types; Early Mentoring Experience: Thoughtworks Model and Sponsorship. Related topics: mentoring, [career development]({{ '/wiki/career-development/' | relative_url }}), [career transition]({{ '/wiki/career-transition/' | relative_url }}), [leadership]({{ '/wiki/leadership/' | relative_url }}), [data engineering]({{ '/wiki/data-engineering/' | relative_url }}).
