...
layout: "person"
title: "Jeff Katz"
summary: "Machine learning engineer and educator contributing practical guidance on data engineering bootcamps, Python and SQL depth, portfolio evidence, and interview preparation."
source_url: "https://datatalks.club/people/jeffkatz.html"
podcast_episodes: ["data-engineering-career-path-and-skills", "get-data-engineering-job-prep-and-interview"]
linkedin: "jeff-katz-5417a65"
curated: "true"
expertise: ["data engineering education", "bootcamp curriculum", "Python", "SQL", "portfolio projects", "technical interviews", "job search"]
---
...
from a broad field into a teachable, job-oriented path for junior candidates.

## Bootcamp Curriculum and Active Learning
...
instruction constantly checks what students understand. A polished lecture
doesn't prove retention.

Around 11:44-14:30, he describes lessons as a sequence of syllabus and labs.
Readings and lecture blocks sit inside that sequence. Smaller labs build toward
larger labs that reinforce earlier material. Students need repeated work with
concepts before they're expected to perform in projects or interviews.

## Python, SQL, and Tool Depth
...
maintainers force reliability and CI/CD habits. They also force Docker usage
and reviewable Python and SQL.
...
screens, he references SQL screens and easy Python problems. Take-home tasks
often ask candidates to load, query, and present data.
...
## Career Transitions and Applied Experience
...
credible applied experience. Internships and short paid projects can play the
same role when a candidate lacks a formal data engineering title.
