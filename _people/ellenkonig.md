...
- [How to Become a Data Engineer: Skills, MLOps, Pipelines, SQL, CI/CD & Cloud]({{ '/podcasts/from-software-engineering-data-science-to-data-engineering-leadership/' | relative_url }}). Related topics: [data science]({{ '/wiki/data-science/' | relative_url }}), [data engineering]({{ '/wiki/data-engineering/' | relative_url }}), [career transition]({{ '/wiki/career-transition/' | relative_url }}), [MLOps]({{ '/wiki/mlops/' | relative_url }}), [tools]({{ '/wiki/tools/' | relative_url }}).
